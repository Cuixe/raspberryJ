package org.cuixe.raspberry.uitls;
...
public class TimeUtils {
    ...
    public void scheduling() {
        long turnOnTimeDelay = org.cuixe.raspberry.utils.TimeUtils.getRemainingTime(18, 0, 0);
        if(turnOnTimeDelay < 0) {
            turnOnTimeDelay = 0;
        }
        long turnOffTimeDelay = org.cuixe.raspberry.utils.TimeUtils.getRemainingTime(1,01, 00, 0);
